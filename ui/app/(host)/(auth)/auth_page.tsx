  ...
  return (
    <ScrollView style={{backgroundColor: theme.colors.background}}> 
        ...
        <View style={{padding: 20, gap: 30, marginTop: 20}}>
          <TouchableOpacity onPress={() => router.push('/(auth)/auth_form')} style={{backgroundColor: theme.colors.primary, width: '100%', borderRadius: 10, height: 50, alignItems: 'center', justifyContent: 'center'}}>
            <ThemedText>Sign Up</ThemedText>
          </TouchableOpacity>

          <TouchableOpacity onPress={() => router.push('/(auth)/sign_in')} style={{backgroundColor: theme.colors.primary, width: '100%', borderRadius: 10, height: 50, alignItems: 'center', justifyContent: 'center'}}>
