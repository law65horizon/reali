...
export default function HomesTab() {
  ...
  return (
    <ThemedView style={{paddingBottom: 0,}}>
      {/* <View style={{flex: 1, alignItems: 'center', paddingHorizontal: 20, backgroundColor: theme.colors.backgroundSec, paddingBottom:10,position: 'absolute', left: 0, width: '100%', zIndex:9, }}> 
        <MaterialCommunityIcons name='filter-variant' size={30} color={theme.colors.text} />
      </View> */}
      <FlatList 
            data={data}
